...
document.addEventListener("DOMContentLoaded", function () {
    ...
    form.addEventListener("submit", function (e) {
        ...
        fetch("https://script.google.com/macros/s/AKfycbxexs5CsGA6Mc1yigClydqjSH14audV2nMG4t4UIYQ6zdMVqrUbTLmEFY1q6VpGW94/exec", {
            method: "POST",
            body: formData
        })
            ...
            .then(data => {
                if (data.result === "success") {
                    ...
                    const startParam = "69440b80db5f0b22a0052e37";
                    ...
                    const telegramValue = form.querySelector('input[name="Телеграм"]');
